...
//funcao p construir secao about
async function getAboutGithub() {
    try {

        const resposta = await fetch('https://api.github.com/users/julianaenob-hub')
    ...
    <!-- Imagem da Seção Sobre Mim -->
            <figure class="about-image">
                ...
                <article class="about-content">
                    <h2>Sobre Mim</h2>
                    <p>Sou uma desenvolvedora Full Stack apaixonada por criar experiências digitais incríveis. Com
                        habilidades em diversas tecnologias, estou sempre em busca de novos desafios e oportunidades
                        para aprimorar minhas habilidades.</p>
                    <p>Se você está procurando alguém para transformar suas ideias em realidade, entre em contato
                        comigo!</p>
                    ...
                    <div class="about-buttons-data">
                        ...
                        <div class="buttons-container">
                            ...
                            <a href="./assets/icons/docs/JULIANA CURRICULO ATUALIZADO 2026.pdf" target="_blank"
                                class="botao-outline">Currículo</a>
                        </div>
...
//funcao p construcao do carrossel com o swiper

async function getProjectsGitHub() {
    try {

        const resposta = await fetch('https://api.github.com/users/julianaenob-hub/repos?sort=update&per_page=6')
        ...
        repositorios.forEach((repositorio) => {
            ...
            //seleciona linguagem padrao do repositorio
            const linguagem = repositorio.language || 'GitHub'

            //seleciona o icone da linguagem padrao
            const icone = linguagens[linguagem] ?? ['GitHub']

            //construir o link do icone
            ...
            //construindo a descricao do card
